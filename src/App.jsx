...
import ipadPic from "./assets/image-devices.png";
...
function App() {
  ...
  return (
    <div>
      ...
      <section className="first-section">
        <div className="first-section-info">
          ...
          <p>
            ...
            <span> access your clipboard on all your devices</span>
          </p>
          <div className="first-section-buttons">
            <button className="button1">Download for IOS</button>
            <button className="button2">Download for MAC</button>
          </div>
        </div>

        <div className="first-section-second-info">
      ...
      <section className="second-section">
        <div className="second-section-flex">
          <div data-aos="fade-right">
            <img src={computer} alt="computer" id="computer-pic" />
          </div>
          ...
          <div data-aos="fade-left">
            <div>
              <h1>Quick Search</h1>
              <p>
                <span>Easily search your snippets by content,</span>
                <span>category, web address, application, and more</span>
              </p>
            </div>

            <div className="second-section-MT">
              <h1>iCloud Sync</h1>
              <p>
                <span>Instantly saves and syncs snippets accross all</span>
      ...
      <section className="third-section" data-aos="zoom-out-up">
        <div className="third-section-header">
          ...
          <p>
            ...
            <span>in a few simple clicks.</span>
          </p>
        </div>
        <div className="third-section-pic">
          <img src={ipadPic} alt="ipad" id="computer-pic" />
        </div>
      ...
      <section className="fourth-section">
        <div className="list-canDo">
          <div data-aos="flip-left">
            ...
            <p>
              <span>Ensure sensitive information never makes its </span>
              <span>way to your clipboard by excluding certain </span>
              <span>sources.</span>
            </p>
          </div>
          <div data-aos="flip-left">
            ...
            <p>
              <span>Remove unwanted formatting from copied text </span>
          ...
          <div data-aos="flip-left">
            ...
            <h1>Sneak preview</h1>
            <p>
              <span>Quick preview of all snippets on Clipboard</span>
        ...
        <div className="list-company">
          <div className="company-logo-pic">
            <img src={google} alt="Google" className="CompanyLogo" />
          </div>
          <div className="company-logo-pic">
            <img src={ibm} alt="IBM" className="CompanyLogo" />
          </div>
          <div className="company-logo-pic">
            <img src={microsoft} alt="microsoft" className="CompanyLogo" />
          </div>
          <div className="company-logo-pic">
            <img src={hp} alt="HP" className="CompanyLogo" />
          </div>
          <div className="company-logo-pic">
            <img src={vector} alt="vector graphics" className="CompanyLogo" />
          </div>
        </div>
      </section>
      ...
      <section className="fifth-section">
        <div>
          ...
          <p>
            <span>
              Avaible for free in App Store. Download for Mac or IOS, sync with
              iCloud and{" "}
            </span>
            <span>you're ready to start adding to your clipboard</span>
          </p>
          <div className="fifth-section-button">
            <button className="fifth-button-one">Download for IOS</button>
            <button className="fifth-button-two">Download for Mac</button>
          </div>
        </div>
      </section>
